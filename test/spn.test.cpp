...
TEST_CASE( "SPN S-boxes", "[spn]" ) {
    ...
    CHECK( spn.S_inv( 0b0100'0101'1101'0001 ) == 0b0001'1100'0010'0011 );
    CHECK( spn.S_inv( 0b0011'1000'0010'0110 ) == 0b1000'0111'0100'1010 );
    CHECK( spn.S_inv( 0b1001'1111'1011'0000 ) == 0b1101'0101'0110'1110 );
    CHECK( spn.S_inv( 0b0110'1010'1110'1001 ) == 0b1010'1001'0000'1101 );
}
